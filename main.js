...
btn.addEventListener("click", () => {
  ...
  console.log("Input word:", inpWord.value);
  results.style.display = "block";
  const word = document.getElementById("word-name");
  if (inpWord.value != "") {
    resultFound.style.display = "block";
    wordAdd.style.display = "block";
    word.innerHTML = inpWord.value;
  } else {
    wordAdd.style.display = "none";
    word.innerHTML = "Sorry...couldn't find the word!!!";
...
//async added so that the function waits for the fetch rather than jumping to catch and displaying the sry message
...
//     noResult.innerHTML = `<h3>Sry...couldn't find "${inpWord}" !!</h3>`;
